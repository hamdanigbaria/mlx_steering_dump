...
RESOURCE_DUMP_SEGMENT_TYPE_STE_BIN = '003e'
RESOURCE_DUMP_SEGMENT_TYPE_STC_BIN = '003c'
RESOURCE_DUMP_SEGMENT_TYPE_ACTION_STC_BIN = '003b'
RESOURCE_DUMP_SEGMENT_TYPE_STC_INFO_META_BIN = '5039'
RESOURCE_DUMP_SEGMENT_TYPE_STC_INFO_RAW_BIN = '503a'
RESOURCE_DUMP_SEGMENT_TYPE_MODIFY_PAT_BIN = '103d'
RESOURCE_DUMP_SEGMENT_TYPE_MODIFY_ARG_BIN = '003d'
RESOURCE_DUMP_SEGMENT_TYPE_FLOW_COUNTER_BIN = '1318'
RESOURCE_DUMP_SEGMENT_TYPE_FT_META_BIN = '1c4016'
RESOURCE_DUMP_SEGMENT_TYPE_STE_INFO_BIN = '5037'
RESOURCE_DUMP_SEGMENT_TYPE_STC_META_BIN = '5039'
RESOURCE_DUMP_SEGMENT_TYPE_STC_RAW_BIN = '503a'
RESOURCE_DUMP_SEGMENT_TYPE_MOD_PATT_BIN = '503b'
RESOURCE_DUMP_SEGMENT_TYPE_MOD_ARG_BIN = '503c'
RESOURCE_DUMP_SEGMENT_TYPE_FLOW_COUNT_BIN = '503d'

STE_ENTRY_TYPE_MATCH = 0x4
STE_ENTRY_TYPE_JUMBO_MATCH = 0x5
STE_ENTRY_TYPE_RANGE_MATCH = 0x7
STE_ENTRY_TYPE_4DW_RANGE_MATCH = 0x8

DR_TBL_TYPE_NIC_RX = 'NIC_RX'
DR_TBL_TYPE_NIC_TX = 'NIC_TX'
DR_TBL_TYPE_FDB = 'FDB'
DR_TBL_TYPE_FDB_RX = 'FDB_RX'
DR_TBL_TYPE_FDB_TX = 'FDB_TX'
DR_TBL_TYPE_FDB_UNIFIED = 'FDB_UNIFIED'
DR_TBL_TYPE_RDMA_TRANSPORT_RX = 'RDMA_TRANSPORT_RX'
DR_TBL_TYPE_RDMA_TRANSPORT_TX = 'RDMA_TRANSPORT_TX'

DR_ROOT_TBL_LEVEL = 0

dr_table_type = [DR_TBL_TYPE_NIC_RX, DR_TBL_TYPE_NIC_TX, DR_TBL_TYPE_FDB, DR_TBL_TYPE_FDB_RX,
                 DR_TBL_TYPE_FDB_TX, DR_TBL_TYPE_FDB_UNIFIED, DR_TBL_TYPE_RDMA_TRANSPORT_RX,
...
class_name_arr = {
    ...
    MLX5DR_DEBUG_RES_TYPE_ACTION_STE_TABLE: "Action STE Table",
}
...
STC_ACTION_INSERT_HEADER = '0b'
STC_ACTION_HEADER_MODIFY_LIST = '0e'
STC_ACTION_TYPE_FLOW_COUNTER = '14'
STC_ACTION_JUMP_TO_STE_TABLE = '80'
STC_ACTION_JUMP_TO_TIR = '81'
STC_ACTION_JUMP_TO_FLOW_TABLE = '82'
STC_ACTION_JUMP_TO_DROP = '83'
STC_ACTION_TYPE_ALLOW = '84'
STC_ACTION_JUMP_TO_VPORT = '85'
STC_ACTION_JUMP_TO_UPLINK = '86'
STC_ACTION_JUMP_TO_QP = '88'
...
_segments_dic = {
    ...
    "HEADER_MOD_PATT": "0x503b",
    "MODIFY_ARGUMENT": "0x1037",
    "HEADER_MOD_ARG": "0x503c",
    "FLOW_COUNTER": "0x1318",
    "FLOW_COUNT": "0x503d",
...
FW_VERSION_MAJOR_CX8 = 40

FW_VERSION_MINOR_EXTRA_HW_RES = "39.0230"
FW_VERSION_MINOR_STC_ACTION_TYPE_SHIFT = "43.0014"
FW_VERSION_MINOR_STC_ACTION_PARAM_LIST = "48.0322"
FW_VERSION_MINOR_EXTRA_HW_RES_COUNTER = "45.0242"
FW_VERSION_MINOR_FORMAL_RD_SEGMENTS = "49.0236"
